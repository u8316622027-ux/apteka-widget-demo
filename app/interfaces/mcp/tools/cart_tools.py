...
class RedisCartTokenStore(CartTokenStore):
    ...
    def __init__(self, redis_client: Any, *, prefix: str = "cart:session", ttl_seconds: int = 604800) -> None:
...
def add_to_my_cart(
    *,
    ...
    """Tool entrypoint that adds an item and returns updated cart snapshot."""
